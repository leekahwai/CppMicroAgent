...
// Test fixture for IntfB_Tx::close
class IntfB_Tx_close_Test : public ::testing::Test {
protected:
    void SetUp() override {
        // Setup code
    }
...
TEST_F(IntfB_Tx_close_Test, CleanupSucceeds) {
    IntfB_Tx obj;
...
TEST_F(IntfB_Tx_close_Test, HandlesRepeatedCalls) {
    IntfB_Tx obj;
    obj.init();
    std::this_thread::sleep_for(std::chrono::milliseconds(100));
