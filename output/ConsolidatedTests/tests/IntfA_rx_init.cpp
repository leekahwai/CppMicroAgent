...
// Test fixture for IntfA_Rx::init
class IntfA_Rx_init_Test : public ::testing::Test {
protected:
    void SetUp() override {
        // Setup code
    }
...
TEST_F(IntfA_Rx_init_Test, ReturnsTrueOnSuccess) {
    IntfA_Rx obj;
...
TEST_F(IntfA_Rx_init_Test, InitializesObjectProperly) {
    IntfA_Rx obj;
